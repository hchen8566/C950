...
class Package:
    ...
    def summary(self):
        print(f"ID: {self.package_id}, Address: {self.street}, Deadline: {self.deadline}, Depart Time: {self.departureTime}, Delivery Time: {self.deliveryTime}, Status: {self.status}")
